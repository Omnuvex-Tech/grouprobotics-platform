...
function MarqueeRow({
  ...
  useEffect(() => {
    ...
    const measure = () => {
      ...
      // We need enough copies so the track is always at least
      // (viewport width + one set width) wide — that guarantees there's
      // always a full extra set ready to scroll in, no matter how narrow
      // the item list is relative to the section.
